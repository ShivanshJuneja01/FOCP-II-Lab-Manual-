//WAP that solves a quadratic equation of the form ax^2+bx+c=0 using conditional statements to handle
// all handle all possible cases(real and distinct cases, real and equal roots, complex roots).
