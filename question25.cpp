// wap that continuously accpets user input until the user types "exit." at the end , display : the sum of all entered numbers ; the count valid integers entered ; the maximum and minimum numbers. 
#include <iostream>
#include <string>
using namespace std;
